...
|
*/
$config['encryption_key'] = 'hobjrLiHi+hzNBt1S8EdsMvOa1amrRcQ0jrbpIexewQZ1R0jyy36qLlwVt6vDXYr';
...
$config['csrf_token_name'] = 'csrf_tempcdm_name';
$config['csrf_cookie_name'] = 'csrf_cempcdm_name';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
$config['csrf_exclude_uris'] = array('admin/users', 'admin/registration/pending', 'admin/registration/approve/list', 'admin/registration/rejected', 'admin/logs');
