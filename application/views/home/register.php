        ...
        <section id="registration_container" class="register-bg">
            <div class="container text-white">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 mt-2 mb-1">
                        <span class="font-weight-light h5">Register for Emperador's Nationwide University Cocktail Showdown exclusively for Hotel Managment/HRM Students! Craft a creative video showcasing your mixology skills with Emperador Original or Emperador Light. Capture your winning shots and be part of the ulimate sip, shake, and win experience.</>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-sm-12 mt-1 mb-1">
                        <span class="font-weight-light h5">Join now and let the cocktail showdown begin!</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-sm-12 mt-1 mb-1">
                        <span class="font-weight-light h5"><i>NOTE: All information are required.</i></span>
                    </div>
                </div> <br>
                <?= form_open_multipart(); ?>
                    <div class="form-row">
